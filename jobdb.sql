...
CREATE TABLE `apply` (
  ...
  KEY `apply_postId_idx` (`post_id`),
  CONSTRAINT `apply_employeeId` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `apply_postId` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `employee` VALUES (1,'Yến','Võ Hoàng','1999-03-29 00:00:00','Nữ','a.docx','0978654321','vohoangyen@gmail.com','799 Nguyễn Kiệm, p3,gv','no experience',7000000,11,1,2),(2,'Thảo','Lê Thị Thu','1999-06-01 00:00:00','Nữ','b.docx','0987654321','lettthao@gmail.com','875 Nguyễn Kiệm, p3,gv','no experience',8000000,21,1,2),(3,'Thanh','Văn','1999-03-03 00:00:00','Nam','a.docx','0912345678','nvt@gmail.com','123 Lê Lai, p6, Gò Vấp','2 năm',8000000,22,2,2);
...
-- Dump completed on 2021-05-12 22:15:41
