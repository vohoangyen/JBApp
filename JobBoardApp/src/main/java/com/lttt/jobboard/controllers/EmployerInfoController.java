...
//        view.addObject("employers", this.employerService.getAllEmployer(username));       
    ...
    public String updateEmployerProcess(Model model,
        ...
        employerService.updateEmployer(addEmployer,rootDir);
        return "redirect:/employer-info/{employer_id}";
    }
    ...
    @GetMapping(value = "/search-applyer")
    public ModelAndView searchApplyers(@RequestParam(value = "kw", defaultValue = "") String kw,           
